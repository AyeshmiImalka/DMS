            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Cannabies Database Table</h4>
                        </div>
                    ...
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM cannabies_db ";
                                ...
                                $sql = "SELECT * FROM cannabies_db  LIMIT $offset, $records_per_page";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>
										<button class='btn btn-sm btn-danger delete-btn' data-id='" . $row["cannabies_id"] . "'><i class='fas fa-trash-alt'></i></button>
										<button class='btn btn-sm btn-info edit-btn' data-id='" . $row["cannabies_id"] . "'><i class='fas fa-edit'></i></button>
                                              </td>";
                                        echo "</tr>";
                                    }
                                } else {
