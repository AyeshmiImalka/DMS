...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO cannabies_db (Reg_id, Reg_name, Manufacturer, Reg_date, `LicenseRenewal(yrs)`, Renewal_update) VALUES ('$reg_id', '$reg_name', '$manufacturer', '$reg_date', '$license_years', '$renewal_update')";
