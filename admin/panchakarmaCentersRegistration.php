            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Panchakarma Centers Registration</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                Panchakarma Centers Registration
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM panchakarma_centers_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM panchakarma_centers_registration_requests LIMIT $offset, $records_per_page";
    ...
    <script>
        $(document).ready(function() {
            $('[data-toggle="modal"]').click(function() {
                ...
                // Extracting center name and email address
                var center_name = $(this).closest('tr').find('td:eq(2)').text(); // Corrected the index to 2 for center name
                ...
                var subject;
                if (status == 'Approved') {
                    subject = 'Your registration request for ' + center_name + ' has been approved';
                } else if (status == 'Rejected') {
                    subject = 'Regarding your registration request for ' + center_name;
                } else if (status == 'Pending') {
                    subject = 'Update on your registration request for ' + center_name;
                }
