...
<div class="main-container">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                Ayurvedic Pharmacies Registration
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM private_ayurvedic_pharmacies_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM private_ayurvedic_pharmacies_registration_requests LIMIT $offset, $records_per_page";
    ...
    $('[data-toggle="modal"]').click(function() {
        ...
        var pharmacy_name = $(this).closest('tr').find('td:eq(2)').text(); // Corrected the index to 2 for pharmacy name
        ...
        var subject;
        if (status == 'Approved') {
            subject = 'Your registration request for ' + pharmacy_name + ' has been approved';
        } else if (status == 'Rejected') {
            subject = 'Regarding your registration request for ' + pharmacy_name;
        } else if (status == 'Pending') {
            subject = 'Update on your registration request for ' + pharmacy_name;
        }
