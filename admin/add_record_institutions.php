...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO ayurvedainstitutions_db (Reg_id, Reg_name, `Location`, Reg_date, `LicenseRenewal(yrs)`, Renewal_update) VALUES ('$reg_id', '$reg_name', '$location', '$reg_date', '$license_years', '$renewal_update')";
