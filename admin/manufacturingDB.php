...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM manufacturingcenters_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM manufacturingcenters_db WHERE Reg_id = '$id'";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM manufacturingcenters_db";
                                    ...
                                    $sql = "SELECT * FROM manufacturingcenters_db LIMIT $offset, $records_per_page";
            ...
            <!-- Add Record Modal -->
            <?php include('database/manufacturing_centers/addManufacture.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/manufacturing_centers/editManufacture.php'); ?>
