...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM hospitals_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM hospitals_db WHERE Reg_id = '$id'";
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Private Ayurveda Hospitals Database Table</h4>
                        </div>
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-hospital-btn" class="btn btn-warning" style="margin-left: 20px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM hospitals_db ";
                                ...
                                $sql = "SELECT * FROM hospitals_db  LIMIT $offset, $records_per_page";
            ...
            <?php include('includes/footer.php');?>
             ...
             <!-- Add Record Modal -->
             <?php include('database/hospitals/addHospitals.php'); ?>

             <!-- Edit Record Modal -->
             <?php include('database/hospitals/editHospitals.php'); ?>
...
$('#addRecordForm').submit(function(e) {
    ...
    $('#expired-hospital-btn').click(function() {
        fetchExpiredLicenses('hospital');
    });
            </script>
        </div>
    </div>
