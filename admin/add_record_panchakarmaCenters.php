...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO panchakarmacenters_db (Reg_ID, Reg_name, `Location`, Reg_date, `LicenseRenewal(yrs)`, Renewal_update) VALUES ('$reg_id', '$reg_name', '$location', '$reg_date', '$license_years', '$renewal_update')";
