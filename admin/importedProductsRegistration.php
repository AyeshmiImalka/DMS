            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Imported Products Registration</h4>
                        </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM imported_products_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM imported_products_registration_requests LIMIT $offset, $records_per_page";
