            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Cannabis Products Registration</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    Cannabis Products Registration
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM cannabis_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM cannabis_registration_requests LIMIT $offset, $records_per_page";
