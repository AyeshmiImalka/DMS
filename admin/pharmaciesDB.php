...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM pharmacies_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM pharmacies_db WHERE Reg_id = '$id'";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Pharmacies Database Table</h4>
                        </div>
                    ...
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM pharmacies_db ";
                                ...
                                $sql = "SELECT * FROM pharmacies_db LIMIT $offset, $records_per_page";
            ...
            <!-- Add Record Modal -->
            <?php include('database/pharmacies/addPharmacies.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/pharmacies/editPharmacies.php'); ?>
