...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM drugstores_db WHERE Renewal_update < CURDATE()";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-drugstores-btn" class="btn btn-warning" style="margin-left: 20px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM drugstores_db ";
            ...
            <!-- Add Record Modal -->
            <?php include('database/drug_stores/addDrugStores.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/drug_stores/editDrugStores.php'); ?>
...
function fetchExpiredLicenses(table) {
    ...
    // Click event for drugstores expired licenses
    $('#expired-drugstores-btn').click(function() {
        fetchExpiredLicenses('drugstores');
    });
