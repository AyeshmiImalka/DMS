                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM private_ayurvedic_drug_stores_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM private_ayurvedic_drug_stores_registration_requests LIMIT $offset, $records_per_page";
