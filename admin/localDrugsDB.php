...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM localdrugs_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM localdrugs_db WHERE Reg_id = '$id'";
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Local Ayurveda Drugs Database Table</h4>
                        </div>
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-localdrug-btn" class="btn btn-warning" style="margin-left: 20px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM localdrugs_db";
                                ...
                                $sql = "SELECT * FROM localdrugs_db LIMIT $offset, $records_per_page";
            ...
            <?php include('includes/footer.php');?>
             ...
             <!-- Add Record Modal -->
             <?php include('database/local_drugs/addLocalDrugs.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/local_drugs/editLocalDrugs.php'); ?>
...
$('#addRecordForm').submit(function(e) {
    ...
    $('#expired-localdrug-btn').click(function() {
        fetchExpiredLicenses('localdrug');
    });
            </script>
        </div>
    </div>
