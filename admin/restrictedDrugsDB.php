...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM restricteddrugs_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM restricteddrugs_db WHERE Reg_id = '$id'";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-restricteddrug-btn" class="btn btn-warning" style="margin-left: 20px;">
            ...
            <!-- Add Record Modal -->
            <?php include('database/restricted_drugs/addRestrictedDrugs.php'); ?>

           <!-- Edit Record Modal -->
           <?php include('database/restricted_drugs/editRestrictedDrugs.php'); ?>
...
$('#addRecordForm').submit(function(e) {
                        ...
                        $.ajax({
                            url: 'add_record_restricteddrugs.php',
                            type: 'POST',
                            data: formData,
                            success: function(response) {
                                if (response == 1) {
                ...
                $('.edit-btn').click(function() {
                    var id = $(this).data('id');
                    $.ajax({
                        url: 'get_record_restricteddrugs.php',
                        type: 'POST',
                        data: { id: id },
                        success: function(response) {
    ...
    $('#expired-restricteddrug-btn').click(function() {
        fetchExpiredLicenses('restricteddrug');
    });
            </script>
        </div>
    </div>
