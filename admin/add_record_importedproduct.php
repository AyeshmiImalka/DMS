...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO importedproducts_db (Reg_ID, Reg_name, Manufacturer, Reg_date, `LicenseRenewal(yrs)`, Renewal_update) VALUES ('$reg_id', '$reg_name', '$manufacturer', '$reg_date', '$license_years', '$renewal_update')";
