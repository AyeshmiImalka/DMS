    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editRecordModalLabel">Edit Transport Service</h5>
                ...
                <form id="editRecordForm">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="editRegName">Service Name</label>
                            <input type="text" class="form-control" id="editRegName" name="regName" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="editRegId">Service ID</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="editVehicleType" name="vehicleType" required>
                        </div>
                    </div>
