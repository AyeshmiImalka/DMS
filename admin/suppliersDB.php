...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM suppliers_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM suppliers_db WHERE Reg_id = '$id'";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-supplier-btn" class="btn btn-warning" style="margin-left: 20px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM suppliers_db ";
                                ...
                                $sql = "SELECT * FROM suppliers_db  LIMIT $offset, $records_per_page ";
            ...
            <!-- Add Record Modal -->
            <?php include('database/suppliers/addSuppliers.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/suppliers/editSuppliers.php'); ?>
...
$('#addRecordForm').submit(function(e) {
    ...
    // Click event for suppliers expired licenses
    $('#expired-supplier-btn').click(function() {
        fetchExpiredLicenses('supplier');
    });	
            </script>
        </div>
    </div>
