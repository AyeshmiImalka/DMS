...
$sql_expired_count = "SELECT COUNT(*) AS expired_count FROM panchakarmacenters_db WHERE Renewal_update < CURDATE()";
...
if(isset($_POST['id'])) {
    $id = $_POST['id'];
    $sql_delete = "DELETE FROM panchakarmacenters_db WHERE Reg_id = '$id'";
...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>panchakarma Centers Database Table</h4>
                        </div>
                ...
                <div class="pb-20">
                    <div id="DataTables_Table_2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div id="DataTables_Table_2_filter" class="dataTables_filter">
                            ...
                            <button id="expired-panchakarma-btn" class="btn btn-warning" style="margin-left: 20px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM panchakarmacenters_db ";
                                ...
                                $sql = "SELECT * FROM panchakarmacenters_db  LIMIT $offset, $records_per_page";
            ...
            <!-- Add Record Modal -->
            <?php include('database/panchakarmaCenters/addPanchakarmaCenters.php'); ?>

            <!-- Edit Record Modal -->
            <?php include('database/panchakarmaCenters/editPanchakarmaCenters.php'); ?>
...
$('#addRecordForm').submit(function(e) {
                        ...
                        $.ajax({
                            url: 'add_record_panchakarmaCenters.php',
                            type: 'POST',
                            data: formData,
                            success: function(response) {
                                if (response == 1) {
                ...
                $('.edit-btn').click(function() {
                    var id = $(this).data('id');
                    $.ajax({
                        url: 'get_record_panchakarmaCenters.php',
                        type: 'POST',
                        data: { id: id },
                        success: function(response) {
    ...
    $('#expired-panchakarma-btn').click(function() {
        fetchExpiredLicenses('panchakarma');
    });
            </script>
        </div>
    </div>
