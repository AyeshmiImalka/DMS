            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Private Ayurveda Institutions Registration</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    Private Ayurveda Institutions Registration
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM private_ayurveda_institutions_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM private_ayurveda_institutions_registration_requests LIMIT $offset, $records_per_page";
    ...
    <script>
        $(document).ready(function() {
            $('[data-toggle="modal"]').click(function() {
                ...
                // Extracting institution name and email address
                var institution_name = $(this).closest('tr').find('td:eq(2)').text(); // Corrected the index to 2 for institution name
                ...
                var subject;
                if (status == 'Approved') {
                    subject = 'Your registration request for ' + institution_name + ' has been approved';
                } else if (status == 'Rejected') {
                    subject = 'Regarding your registration request for ' + institution_name;
                } else if (status == 'Pending') {
                    subject = 'Update on your registration request for ' + institution_name;
                }
