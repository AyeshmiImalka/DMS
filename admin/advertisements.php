    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Advertisement Requests Table</h4>
                </div>
                <div class="pb-20">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_records FROM advertisement_requests";
                                ...
                                $sql = "SELECT * FROM advertisement_requests LIMIT $offset, $records_per_page";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td><a href='". $row["advertisement_sample"]. "' target='_blank'>View Sample</a></td>";
                                        echo "<td>
                                                <a href='approve_advertisement.php?id=". $row["id"]. "' class='btn btn-sm btn-success' data-toggle='modal' data-target='#emailModal' data-status='Approved'>Approved</a>
                                                <a href='reject_advertisement.php?id=". $row["id"]. "' class='btn btn-sm btn-danger' data-toggle='modal' data-target='#emailModal' data-status='Rejected'>Rejected</a>
                                                <a href='pending_advertisement.php?id=". $row["id"]. "' class='btn btn-sm btn-secondary' data-toggle='modal' data-target='#emailModal' data-status='Pending'>Pending</a>
                                              </td>";
                                              echo "<td>
                                    ...
                                    echo "<tr><td colspan='6'>No advertisement requests found.</td></tr>";
                                }
                               ?>
                            </tbody>
                        </table>
...
<div class="modal fade" id="emailModal" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel" aria-hidden="true">
    ...
    $(document).ready(function() {
        $('[data-toggle="modal"]').click(function() {
            ...
            var subject;
            if (status == 'Approved') {
                subject = 'Your advertisement request has been approved';
            } else if (status == 'Rejected') {
                subject = 'Regarding your advertisement request';
            } else if (status == 'Pending') {
                subject = 'Update on your advertisement request';
            }
