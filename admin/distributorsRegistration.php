                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM distributors_registration_requests";
                                    ...
                                    $sql = "SELECT * FROM distributors_registration_requests LIMIT $offset, $records_per_page";
    ...
    <script>
        $(document).ready(function() {
            $('[data-toggle="modal"]').click(function() {
                ...
                // Extracting distributor name and email address
                var distributor_name = $(this).closest('tr').find('td:eq(2)').text(); // Corrected the index to 2 for distributor name
                ...
                var subject;
                if (status == 'Approved') {
                    subject = 'Your registration request for ' + distributor_name + ' has been approved';
                } else if (status == 'Rejected') {
                    subject = 'Regarding your registration request for ' + distributor_name;
                } else if (status == 'Pending') {
                    subject = 'Update on your registration request for ' + distributor_name;
                }
