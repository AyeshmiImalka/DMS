            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Private Ayurveda Hospital Registration</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    Private Ayurveda Hospital Registration
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="table-responsive-md">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_count = "SELECT COUNT(*) AS total_records FROM private_ayurveda_hospital_registration";
                                    ...
                                    $sql = "SELECT * FROM private_ayurveda_hospital_registration LIMIT $offset, $records_per_page";
    ...
    <script>
        $(document).ready(function() {
            $('[data-toggle="modal"]').click(function() {
                ...
                // Extracting hospital name and email address
                var hospital_name = $(this).closest('tr').find('td:eq(2)').text(); // Corrected the index to 2 for hospital name
                ...
                var subject;
                if (status == 'Approved') {
                    subject = 'Your registration request for ' + hospital_name + ' has been approved';
                } else if (status == 'Rejected') {
                    subject = 'Regarding your registration request for ' + hospital_name;
                } else if (status == 'Pending') {
                    subject = 'Update on your registration request for ' + hospital_name;
                }
