...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO local_drugs_registration_requests (drug_name, contact_email) VALUES (?, ?)";
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4" style="color: #318BFF">Local Ayurveda Drugs Registration</h4>
                </div>
                <div class="pb-20">
                    <!-- Form added -->
