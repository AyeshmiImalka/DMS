...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    if (empty($supplier_name) || empty($contact_email)) {
        die("Error: Both Supplier name and contact email must be filled.");
    }

    // Prepare SQL statement to prevent SQL injection
    $sql = "INSERT INTO suppliers_registration_requests (supplier_name, contact_email) VALUES (?, ?)";
    $stmt = $conn->prepare($sql);

    if ($stmt) {
        // Bind parameters and execute the statement
        $stmt->bind_param("ss", $supplier_name, $contact_email);
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4" style="color: #318BFF">Suppliers Registration</h4>
                </div>
                <div class="pb-20">
                    <!-- Form added -->
                    <div class="form-instructions">
                        <form id="registrationForm" method="post" action="">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="businessName" name="supplier_name" class="form-control" placeholder="Enter business name" required>
                                </div>
                            </div>
                            <div class="form-group row">
