...
<body>
	...
	<div class="header">
		<div class="header-left">
			...
			<h5 style="color: #318BFF">Welcome, <?php echo $_SESSION['user_name']; ?>!</h5> <!-- please add $user_name later-->
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a
						...
						$sql_fetch = "SELECT * FROM user_profiles WHERE user_name = '{$_SESSION['user_name']}'";
