...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    if (empty($institution_name) || empty($contact_email)) {
        die("Error: Both drug name and contact email must be filled.");
    }

    // Prepare SQL statement to prevent SQL injection
    $sql = "INSERT INTO private_ayurveda_institutions_registration_requests (institution_name, contact_email) VALUES (?, ?)";
    $stmt = $conn->prepare($sql);

    if ($stmt) {
        // Bind parameters and execute the statement
        $stmt->bind_param("ss", $institution_name, $contact_email);
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="title">
                            <h4>Private Ayurveda Institution Registration</h4>
                        </div>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4" style="color: #318BFF">Private Ayurveda Institution Registration</h4>
                </div>
                <div class="pb-20">
                    <!-- Form added -->
                    <div class="form-instructions">
                        <form id="registrationForm" method="post" action="">
                            <div class="form-group row">
                                <label for="businessName" class="col-sm-3 col-form-label">Institution Name:</label>
                                <div class="col-sm-9">
                                    <input type="text" id="businessName" name="institution_name" class="form-control" placeholder="Enter business name" required>
                                </div>
                            </div>
                            <div class="form-group row">
